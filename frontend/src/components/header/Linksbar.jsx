...
const Linksbar = () => {
  return (
      ...
      <div 
        className="flex justify-center items-center p-2 bg-green-900 px-8
        md:justify-between
      ">
      ...
      <div className="email justify-center items-center hidden md:block">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 text-xl hover:text-white inline-flex gap-2 justify-center items-center"
          >
            {/* SVG */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="text-base underline">info@scottishhindufoundation.com</p>
          </a>
